...
function UserWelcome() {
  ...
  const submitAddUser=(formInputState)=>{
    axios.post(`/p25user/adduser`,formInputState,myheader)
    .then(result=>{
  ...
  const submitChangePassword=(formInputState)=>{
    axios.post(`/p25user/changepassword`,formInputState,myheader)
    .then(result=>{
  ...
  const submitLogIn=(formInputState)=>{
    axios.post(`/p25user/login`,formInputState,myheader)
    .then(result=>{
