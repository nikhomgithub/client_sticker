...
import {MdSettingsApplications,MdGridOn} from 'react-icons/md';
...
export default function Navbar() {
    ...
    const refSticker=React.createRef()
    ...
    <div className="navFrame flex-center-center jc-space-between">
            ...
            <div id="1" className="h-100" 
                ...
                <div className="navLink" onClick={e=>refSticker.current.click()}> 
                    <div className="navIconBox">
                        <MdGridOn className="navIcon"/>
                    </div>
                    <div className="navTextBox">
                        <p className="navText">สติกเกอร์</p>
                    </div>
                </div>
            </div>    
            ...
            <div className="d-none">
                ...
                <Link ref={refUser} to="/p31/user"/>
                <Link ref={refSticker} to="/p31/sticker"/>
